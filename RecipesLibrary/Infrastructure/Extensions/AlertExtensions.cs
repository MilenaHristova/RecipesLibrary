...
namespace RecipesLibrary.Infrastructure.Extensions
{
    public static class AlertExtensions
    {
        ...
        private static ICollection<Alert> GetAlerts(Controller controller)
        {
            ...
            ICollection<Alert> alerts = JsonConvert
                .DeserializeObject<ICollection<Alert>>(controller.TempData[AlertKey].ToString());
